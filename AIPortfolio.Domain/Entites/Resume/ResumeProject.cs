...
public sealed class ResumeProject : BaseEntity
{
    ...
    public string? Technologies { get => TechStack; set => TechStack = value; }
    public string? Url { get => ProjectUrl; set => ProjectUrl = value; }
    public int OrderIndex { get; set; }
    public int DisplayOrder { get => OrderIndex; set => OrderIndex = value; }
    public string? LiveDemoUrl { get => ProjectUrl; set => ProjectUrl = value; }
